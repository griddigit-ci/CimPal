...
import static eu.griddigit.cimpal.application.MainController.prefs;
...
public class ModelFactory {
    ...
    public static Model modelLoadXMLmapping(InputStream inputStream, Map<String, RDFDatatype> dataTypeMap, String xmlBase) {
        ...
        DataTypeStreamRDF sink = new eu.griddigit.cimpal.util.DataTypeStreamRDF(graph, dataTypeMap);
