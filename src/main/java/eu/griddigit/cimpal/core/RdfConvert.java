...
public class RdfConvert {
    ...
    public static void rdfConversion(File file, List<File> files, String sourceFormat, String targetFormat, String xmlBase, RDFFormat rdfFormat,
        ...
        if (modelUnionFlagDetailed) {
            ...
            fileDet1 = eu.griddigit.cimpal.util.ModelFactory.fileChooserCustom(true, "RDF file", List.of("*.rdf", "*.xml", "*.ttl"), "Main RDF file");
            if (!fileDet1.isEmpty()) {
            ...
            fileDet2 = eu.griddigit.cimpal.util.ModelFactory.fileChooserCustom(true, "RDF file", List.of("*.rdf", "*.xml", "*.ttl"), "Deviation RDF file");
            ...
            fileDet3 = eu.griddigit.cimpal.util.ModelFactory.fileChooserCustom(true, "RDF file", List.of("*.rdf", "*.xml", "*.ttl"), "Extended RDF file");
            ...
            // load all models
            model = eu.griddigit.cimpal.util.ModelFactory.modelLoad(modelFiles, xmlBase, rdfSourceFormat, false);
        }
...
//        filechooserS.setTitle(title);
        File saveFile = eu.griddigit.cimpal.util.ModelFactory.fileSaveCustom(extensionName, List.of(extension), title, title.split(": ", 2)[1]);
        try {
//            try {
