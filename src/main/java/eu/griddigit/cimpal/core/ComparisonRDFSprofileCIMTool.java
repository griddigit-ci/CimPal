...
public class ComparisonRDFSprofileCIMTool {

    public static ArrayList<Object> compareRDFSprofileCIMTool(Model modelA, Model modelB){
                ...
                if (attribute.equals("true")) {// it is an attribute
                    ...
                    if (resItem.hasProperty(ResourceFactory.createProperty("http://iec.ch/TC57/1999/rdf-schema-extensions-19990926#", "AssociationUsed"))){
                        ...
                        if (AttrAssocStereotypes.contains("byreference")) {
                            map.putIfAbsent("AssociationUsed", "Yes"); //added 21 Jun 2021
                        }else{
                            map.putIfAbsent("AssociationUsed", "No"); //added 24 Jun 2021
                        }
                    }
                }
                result= new Pair<>(true,map);
