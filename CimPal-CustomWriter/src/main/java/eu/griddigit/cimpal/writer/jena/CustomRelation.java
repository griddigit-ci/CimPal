package eu.griddigit.cimpal.writer.jena;

import eu.griddigit.cimpal.writer.formats.CustomBaseXMLWriter;
 ...
 * <p>
 * Has to be copied, because the original class is package private and {@link CustomBaseXMLWriter} needs it.
 */
public class CustomRelation<T> {
     ...
     * Each pair is returned as a java.eu.griddigit.cimpal.util.Map.Entry.
