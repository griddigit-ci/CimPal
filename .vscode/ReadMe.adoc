...
Download from https://jdk.java.net/25/ or via your package manager.
...
Set `JAVA_HOME` to point to JDK 25.
...
[source,cmd]
----
# Clean and install all modules to your local Maven repository
mvn clean install -DskipTests

# Then run the main application
mvn exec:java -pl CimPal-Main
----
