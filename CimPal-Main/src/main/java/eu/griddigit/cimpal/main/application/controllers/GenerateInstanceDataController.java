...
public class GenerateInstanceDataController implements Initializable {
    ...
    @FXML
    private Label helpUseMethod;
    @FXML
    private Label helpLoadRdfs;
    @FXML
    private Label helpLoadInstances;
    @FXML
    private Label helpHideEmptySheets;
    @FXML
    private Label helpXlsTemplate;
    @FXML
    private Label helpSortingOptions;
    @FXML
    private Label helpStripPrefixes;
    @FXML
    private Label helpExportExtensions;
    ...
    private void initializeHelpTooltips() {
        GUIhelper.installHelpTooltip(helpUseMethod, "Selects the template generation strategy.\n\n'Advanced template' is the current recommended method and supports the full CIM property set.");
        GUIhelper.installHelpTooltip(helpLoadRdfs, "RDFS profile files (.xml, .rdf) defining the CIM class and property structure. Load one or more profiles to drive the template generation.");
        GUIhelper.installHelpTooltip(helpLoadInstances, "Optional CGMES instance data files (XML or ZIP). When loaded, the template will be pre-populated with sample values from the instance data.");
        GUIhelper.installHelpTooltip(helpHideEmptySheets, "When checked, worksheet tabs with no instance data are hidden in the generated Excel template, keeping the file compact.");
        GUIhelper.installHelpTooltip(helpXlsTemplate, "The filled-in Excel template (.xlsx) to convert into CIMXML instance data. Must follow the structure generated by the 'Create xlsx template' section above.");
        GUIhelper.installHelpTooltip(helpSortingOptions, "Controls how output XML elements are ordered:\n\n• Sort alphabetically: sorts subjects by URI\n• Sorting options: secondary sort strategy (by local name or by prefix)");
        GUIhelper.installHelpTooltip(helpStripPrefixes, "Removes namespace prefix declarations that are not used in the generated XML output, keeping the output clean.");
        GUIhelper.installHelpTooltip(helpExportExtensions, "When checked, includes any extension attributes or classes identified in the template in the generated CIMXML output.");
    }
