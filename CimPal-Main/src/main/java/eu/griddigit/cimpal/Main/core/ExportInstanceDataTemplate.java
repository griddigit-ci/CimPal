...
import static eu.griddigit.cimpal.Main.core.ExportRDFSdescriptions.getRDFDataForClasses;
...
public class ExportInstanceDataTemplate {
    ...
    private static void exportDesciptionToJSON(Map<String, List<String>> rdfsInfo) {
        ...
        File saveFile = eu.griddigit.cimpal.Main.util.ModelFactory.fileSaveCustom("JSON files", List.of("*.json"), "", "");
        if (saveFile != null) {
            // Export to JSON
